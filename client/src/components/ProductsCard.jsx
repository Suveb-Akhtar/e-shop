  ...
  return (
    <div className="group relative mx-4">
      <div
        ...
        className="w-full h-70 cursor-pointer overflow-hidden"
      >
        <img
      ...
      <div className="w-full border-[1px] px-2 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="felx justify-end gap-2 relative overflow-hidden w-28 text-sm">
            <div
            ...
            <p
              ...
              hover:text-gray-900 flex items-center gap-1 top-0 transform -translate-x-32
